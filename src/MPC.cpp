...
// Building a single vector wit hall state variables and actuator variables
size_t x_start = 0;
...
vector<double> MPC::Solve(Eigen::VectorXd x0, Eigen::VectorXd coeffs, double target_x, double target_y) {
  ...
  //Number of independant vars: N timesteps --> N-1 actuations
